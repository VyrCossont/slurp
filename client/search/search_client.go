...
type ClientService interface {
	SearchGet(params *SearchGetParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchGetOK, error)
...
func (a *Client) SearchGet(params *SearchGetParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchGetOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "searchGet",
		Method:             "GET",
		PathPattern:        "/api/{api_version}/search",
	...
	msg := fmt.Sprintf("unexpected success response for searchGet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
