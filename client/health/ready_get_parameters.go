...
// NewReadyGetParams creates a new ReadyGetParams object,
...
func NewReadyGetParams() *ReadyGetParams {
	return &ReadyGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewReadyGetParamsWithTimeout creates a new ReadyGetParams object
...
// NewReadyGetParamsWithContext creates a new ReadyGetParams object
...
// NewReadyGetParamsWithHTTPClient creates a new ReadyGetParams object
...
ReadyGetParams contains all the parameters to send to the API endpoint
	...
	for the ready get operation.

	Typically these are written to a http.Request.
*/
type ReadyGetParams struct {
